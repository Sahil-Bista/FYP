...
const editStatus = async(req,res)=>{
  try{
    ...
    const updatedFutsal = await futsalModel.findByIdAndUpdate(futsalId, {isOpen: negation} , {
      new: true, 
    });
...
export { getAllFutsals, createFutsal, getVendorSpecificFutsal , editFutsal, upload, deleteFutsal, getFutsalById, editStatus};
